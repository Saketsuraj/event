						...
						<div class="row justify-content-center">
							<div class="col-lg-6 col-md-12 col-sm-12">
								...
								<div class="breadcrumb-title text-center mb-50">
									<span class="sub-title">L.S.E.S events</span>
									<h2 class="big-title">L.S.E.S <strong>event</strong></h2>
								</div>
						...
						<div class="col-lg-3 col-md-6 col-sm-12">
							<div class="about-wrapper">
								...
								<div class="site-logo-wrapper mb-30">
									<a href="index.html" class="logo">
										<img src="assets/photos/logo.jpg" alt="logo_not_found">
									</a>
								</div>
					...
					<div class="row">
						...
						<div class="col-lg-7 col-md-12 col-sm-12">
							<div class="copyright-text">
								<p class="m-0">©2018
									<a href="#!" class="site-link">lightningspeedevents.com</a> all right reserved, made with
